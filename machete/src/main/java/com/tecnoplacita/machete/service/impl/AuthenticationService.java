...
public class AuthenticationService {
    ...
    private void enviarCorreoVerificacion(String email, String token) {
        try {
            ...
            String enlaceVerificacion = "https://mibolsillo-fya4h9bpbwe0dtg0.mexicocentral-01.azurewebsites.net/verificar?token=" + token;
            String mensajeHtml = "<html>" +
                    ...
                    "<p><strong>Código de seguridad: " + token + "</strong></p>" +
                    "<a href='" + enlaceVerificacion + "'>Verificar cuenta</a>" +
                    "<br><br>" +
                    "<p><em>Este código es único y no debe compartirse con nadie. Si no solicitaste este registro, ignora este mensaje.</em></p>" +
                    "<p>¡Bienvenido a Mi Bolsillo!</p>" +
                    "<p>Saludos,<br>El equipo de Mi Bolsillo</p>" +
                    "</body>" +
                    "</html>";
            ...
            // Puedes lanzar una excepción personalizada o manejar el error según tu lógica de negocio
        }
    }
    ...
    private void enviarCorreoRecuperacion(String email, String token) {
        try {
            ...
            String enlaceRestablecimiento = "https://mibolsillo-fya4h9bpbwe0dtg0.mexicocentral-01.azurewebsites.net/auth/confirm-reset?token=" + token;
            String mensajeHtml = "<html>" +
                    "<body>" +
